...
<title>Class Search by Instructor</title>
...
<body>
	...
	<div class="panel panel-primary col-sm-6 col-sm-offset-3">
		<div class="panel-heading">Search class for Instructor </div>
		<div class="panel-body">
			...
			<form role="form" action="ClassesByInstructor" method="GET">
				<label for="userName">Instructor User Name:</label> 
