...
<body>
	...
	<div class="panel panel-primary col-sm-6 col-sm-offset-3">
		<div class="panel-heading">Search for majors</div>
		<div class="panel-body">
			...
			<form role="form" action="MajorSearch" method="POST">
	...
	<div class="panel panel-primary col-sm-6 col-sm-offset-3">
				...
				<table class="table table-bordered table-striped">
					...
					<tbody>
						<c:forEach var="currentMajor" items="${majors}">
							<tr>
								<td>${currentMajor.name}</td>
								<td>${currentMajor.HDepartment.name}</td>								
