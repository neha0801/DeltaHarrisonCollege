...
SET DEFINE OFF;
Insert into TESTDB.H_USER_ROLE (ROLE_ID,USER_ID,ROLE_STATUS) values (1,1,'Active');
Insert into TESTDB.H_USER_ROLE (ROLE_ID,USER_ID,ROLE_STATUS) values (2,2,'Active');
Insert into TESTDB.H_USER_ROLE (ROLE_ID,USER_ID,ROLE_STATUS) values (3,3,'Active');
Insert into TESTDB.H_USER_ROLE (ROLE_ID,USER_ID,ROLE_STATUS) values (3,4,'Active');
Insert into TESTDB.H_USER_ROLE (ROLE_ID,USER_ID,ROLE_STATUS) values (2,5,'Active');
Insert into TESTDB.H_USER_ROLE (ROLE_ID,USER_ID,ROLE_STATUS) values (4,6,'Active');
...
SET DEFINE OFF;
Insert into TESTDB.H_ENROLLMENT (USER_ID,GRADE,STATUS,CLASS_ID) values (2,'A','Enrolled',1);
Insert into TESTDB.H_ENROLLMENT (USER_ID,GRADE,STATUS,CLASS_ID) values (2,'B','Enrolled',2);
Insert into TESTDB.H_ENROLLMENT (USER_ID,GRADE,STATUS,CLASS_ID) values (2,'A','Enrolled',3);
Insert into TESTDB.H_ENROLLMENT (USER_ID,GRADE,STATUS,CLASS_ID) values (5,'D','Enrolled',4);
Insert into TESTDB.H_ENROLLMENT (USER_ID,GRADE,STATUS,CLASS_ID) values (2,'A','Enrolled',5);
