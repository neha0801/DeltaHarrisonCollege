...
ALTER TABLE H_STAFF_DETAIL
ADD CONSTRAINT fk_STAFF_DETAIL
  FOREIGN KEY (USER_ID)
  REFERENCES H_USER(USER_ID);
  
ALTER TABLE H_USER_ROLE ADD STATUS VARCHAR(20);
...
SET DEFINE OFF;
Insert into TESTDB.H_USER_ROLE (ROLE_ID,USER_ID) values (1,1,'Active');
Insert into TESTDB.H_USER_ROLE (ROLE_ID,USER_ID) values (2,2,'Active');
Insert into TESTDB.H_USER_ROLE (ROLE_ID,USER_ID) values (3,3,'Active');
Insert into TESTDB.H_USER_ROLE (ROLE_ID,USER_ID) values (3,4,'Active');
Insert into TESTDB.H_USER_ROLE (ROLE_ID,USER_ID) values (2,5,'Active');
